...
#define LEN 200
#define NMAX LEN		/* maximum number of vertices handles */
#define MAX_NR_VERTICES		LEN	/* = NMAX */
#define MAX_NR_VERTICESdiv8	LEN/8	/* = NMAX/8 */
#define BOOL	char
#define MAX_PREAMBLE 1000
#define REORDER
#define infile "C125.9.clq.txt"
